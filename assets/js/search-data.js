...
ninja.data = [{
    id: "nav-swathi-shree-narashiman",
      ...
      window.location.href = "/portfolio/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "teachings-computer-organization-ee2003",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%61%72%61%73%68%69%6D@%73%74%61%6E%66%6F%72%64.%65%64%75", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=eI3GlwcAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/BaristaBandits", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/swathi-narashiman", "_blank");
        },
      },{
      id: 'light-theme',
